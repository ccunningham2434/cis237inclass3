...
namespace cis237inclass3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            employees[0] = new HourlyEmployee("James", "Kirk",12.5m);
            employees[1] = new SalaryEmployee("Jean-Luc", "Picard", 55123.00m);
            employees[2] = new HourlyEmployee("Benjamin", "Sisko", 14.56m);
            employees[3] = new SalaryEmployee("Kathryn", "Janeway", 67000m);
            employees[4] = new SalaryEmployee("Johnathan", "Archer", 12000m);
